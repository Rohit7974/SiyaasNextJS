...
// Mock product data - REPLACED 'image' keys with 'images' array
  ...
  const products = [
    {
      ...
      fullDescription: "Immerse yourself in the soothing aroma of lavender fields. Our handcrafted soy candle uses premium essential oils to create a calming atmosphere perfect for relaxation and meditation.",
      price: 599,
      rating: 4.8,
      totalReviews: 127,
      ...
      images: [
        ...
        "https://images.unsplash.com/photo-1602825266977-1b0a701918a7?q=80&w=900&auto=format&fit=crop"
      ],
      category: "Aromatherapy",
      burnTime: "40-45 hours",
      weight: "200g",
      ingredients: ["100% Soy Wax", "Lavender Essential Oil", "Cotton Wick"],
    },
    {
      id: 2,
      name: "Vanilla Bliss Candle",
      description: "Refreshing Digestive Mouth Freshener",
      fullDescription: "Experience pure bliss with our vanilla-scented candle. The warm, comforting aroma creates an inviting ambiance.",
      price: 599,
      rating: 4.6,
      totalReviews: 89,
      images: [
        "https://shivaorganic.com/cdn/shop/files/Beeswax_Candle.jpg?v=1731349398&width=900",
        "https://images.unsplash.com/photo-1570823343906-89680373df9f?q=80&w=900"
      ],
      category: "Sweet Scents",
      burnTime: "40-45 hours",
      weight: "200g",
      ingredients: ["100% Soy Wax", "Vanilla Extract", "Cotton Wick"],
    },
    {
      id: 3,
      name: "Ocean Breeze Candle",
      description: "Wholesome Superfood for Immunity, Energy & Digestion",
      fullDescription: "Bring the freshness of the ocean to your home. Our ocean breeze candle combines marine notes with subtle floral undertones.",
      price: 599,
      rating: 3.7,
      totalReviews: 54,
      images: [
      ...
      category: "Fresh Scents",
      burnTime: "40-45 hours",
      weight: "200g",
      ingredients: ["100% Soy Wax", "Marine Essence", "Cotton Wick"],
    },
    {
      id: 4,
      name: "Sandalwood Serenity",
      description: "Himalayan Superfruit for Skin, Immunity & Energy",
      fullDescription: "Find your inner peace with our sandalwood candle. The rich, woody aroma creates a meditative atmosphere.",
      price: 540,
      rating: 4.9,
      totalReviews: 203,
      oldPrice: 699,
      ...
      category: "Woody Scents",
      burnTime: "45-50 hours",
      weight: "250g",
      ingredients: ["100% Soy Wax", "Sandalwood Oil", "Cotton Wick"],
    },
     {
    id: 5,
