...
const products = [
  { id: 5, video: "/video/video1.mp4", name: "Aromatic Soy Wax Candle – Vanilla Bliss", price: "599" },
  { id: 6, video: "/video/video2.mp4", name: "Handmade Beeswax Candle – Pure Honey Aroma", price: "799" },
  { id: 7, video: "/video/video3.mp4", name: "Luxury 3-Wick Candle – Fresh Lavender", price: "1,299" },
  { id: 8, video: "/video/video1.mp4", name: "Meditation Candle – Sandalwood Calm", price: "999" },
  { id: 9, video: "/video/video2.mp4", name: "Decorative Jar Candle – Rose Garden", price: "699" },
  { id: 10, video: "/video/video3.mp4", name: "Decorative Jar Candle – Rose Garden", price: "699" },
  { id: 11, video: "/video/video1.mp4", name: "Decorative Jar Candle – Rose Garden", price: "699" },
  { id: 12, video: "/video/video2.mp4", name: "Decorative Jar Candle – Rose Garden", price: "699" },
];
...
const ReelProducts = () => {
  ...
  return (
    <div className="relative w-full py-10 px-4">
      ...
      <button
        onClick={scrollLeft}
        className="hidden md:flex absolute left-2 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-black/10 hover:bg-black/20 backdrop-blur-xl items-center justify-center shadow-lg"
      >
        ‹
      </button>
      ...
      <button
        onClick={scrollRight}
        className="hidden md:flex absolute right-2 top-1/2 -translate-y-1/2 z-20 w-12 h-12 rounded-full bg-black/10 hover:bg-black/20 backdrop-blur-xl items-center justify-center shadow-lg"
      >
        ›
      </button>
